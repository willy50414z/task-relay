...
from task_relay.agents.anthropic_sdk import AnthropicSDKRunner
...
BUILTIN_AGENTS = ("claude", "claude-sdk", "codex", "deepseek", "zerotoken")
...
def resolve(name: str | None = None) -> AgentRunner:
    ...
    if agent_name == "claude":
        return ClaudeRunner()
    if agent_name == "claude-sdk":
        return AnthropicSDKRunner()
    if agent_name == "codex":
        return CodexRunner()
