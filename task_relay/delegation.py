...
def _build_review_skill_md() -> str:
    lines = [
        ...
        "```",
        "",
        "At least one reviewer and one arbiter are required. If the user tries to",
        "skip arbiters, stop before execution and explain that review gate requires",
        "an arbiter decision source.",
        "",
